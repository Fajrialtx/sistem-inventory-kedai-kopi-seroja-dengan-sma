...
class Penjualan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('store/penjualan/datapenjualan', $data);
    ...
    public function detail($tanggal)
    {
        ...
        $this->load->view('header', $data);
        $this->load->view('store/navbar', $data);
        $this->load->view('store/penjualan/detailpenjualan', $data);
        $this->load->view('footer');
    }
    ...
    public function tambah()
    {
        ...
        if ($inputan) {
            ...
            if (empty($inputan['id_produk']) || count($inputan['id_produk']) == 0) {
                ...
                redirect('store/penjualan/tambah', 'refresh');
            }
            ...
            if ($query == 'sukses') {
                ...
                redirect('store/penjualan', 'refresh');
            } else {
        ...
        $this->load->view('header', $data);
        $this->load->view('store/navbar', $data);
        $this->load->view('store/penjualan/tambahpenjualan', $data);
        $this->load->view('footer');
    }
