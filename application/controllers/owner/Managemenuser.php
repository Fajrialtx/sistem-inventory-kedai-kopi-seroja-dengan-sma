...
class Managemenuser extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('owner/managemenuser/datauser', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            //tampilkan owner/managemenuser/index
            $this->session->set_flashdata('pesan', 'Data berhasil ditambah!');
            redirect('owner/managemenuser', 'refresh');
        }
        // selain itu gagal  
        else {
        ...
        $this->load->view('header', $data);
        $this->load->view('owner/navbar', $data);
        $this->load->view('owner/managemenuser/tambahuser', $data);
        $this->load->view('footer');
    }
    ...
    public function ubah($id_user)
    {
        ...
        $this->load->view('header', $data);
        $this->load->view('owner/navbar', $data);
        $this->load->view('owner/managemenuser/edituser', $data);
        $this->load->view('footer');
    }
