...
class Stokmasuk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('owner/stokmasuk/datastok', $data);
    ...
    public function detail($tanggal)
    {
        ...
        $this->load->view('header', $data);
        $this->load->view('owner/navbar', $data);
        $this->load->view('owner/stokmasuk/detailstok', $data);
        $this->load->view('footer');
    }
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            redirect('owner/stokmasuk', 'refresh');
        } else {
        ...
        $this->load->view('header', $data);
        $this->load->view('owner/navbar', $data);
        $this->load->view('owner/stokmasuk/tambahstok', $data);
        $this->load->view('footer');
    }
