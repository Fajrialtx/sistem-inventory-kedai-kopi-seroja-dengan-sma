...
class Bahanbaku extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('owner/bahanbaku/databahanbaku', $data);
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            redirect('owner/bahanbaku', 'refresh');
        }
        // selain itu gagal  
        else {
        ...
        $this->load->view('header', $data);
        $this->load->view('owner/navbar', $data);
        $this->load->view('owner/bahanbaku/tambahbahanbaku', $data);
        $this->load->view('footer');
    }
    ...
    public function detail($id_barang)
    {
        ...
        $this->load->view('header', $data);
        $this->load->view('owner/navbar', $data);
        $this->load->view('owner/bahanbaku/detailbahanbaku', $data);
        $this->load->view('footer');
    }
    ...
    public function ubah($id_barang)
    {
        ...
        $data["kategori"] = $this->Mkategori->tampil_kategori();
        $data['title'] = 'Ubah Bahan Baku';

        $this->load->view('header', $data);
        $this->load->view('owner/navbar', $data);
        $this->load->view('owner/bahanbaku/editbahanbaku', $data);
        $this->load->view('footer');
    }
