...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?= base_url('owner/stokmasuk/tambah') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data</a>
</div>
                    ...
                    <?php foreach ($stokmasuk as $key => $value) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('owner/stokmasuk/detail/' . $value['tanggal']); ?>" class="btn btn-info btn-icon-split btn-sm">
