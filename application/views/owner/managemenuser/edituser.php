...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="<?= base_url('owner/managemenuser'); ?>">Managemen User</a></li>
...
<div class="card shadow mb-4 col-md-8 mx-auto">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 md-2">
                    ...
                    <select class="custom-select" name="level">
                        ...
                        <option value="owner" <?php if ($datauser['level'] == 'owner') {
                                                    echo "selected";
                                                } ?>>Owner</option>
                    </select>
                </div>
    ...
    <div class="card-footer text-md-right">
        <a href="<?= base_url('owner/managemenuser'); ?>" class="btn btn-secondary">Batal</a>
