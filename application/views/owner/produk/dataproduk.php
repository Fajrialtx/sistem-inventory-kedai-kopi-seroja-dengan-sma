    ...
    <div class="card-header py-3">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-md-6 text-md-right mt-2 mt-md-0">
                <a href="<?= base_url('owner/produk/tambah'); ?>" class="btn btn-primary btn-icon-split btn-sm">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
            <div class="btn-group" role="group">
                <a href="<?= base_url('owner/produk'); ?>" class="btn btn-sm <?= ($kategori_aktif == 'Semua') ? 'btn-primary' : 'btn-outline-primary'; ?>">
                    <i class="fas fa-th-list mr-1"></i>Semua
                </a>
                <a href="<?= base_url('owner/produk?kategori=Makanan'); ?>" class="btn btn-sm <?= ($kategori_aktif == 'Makanan') ? 'btn-success' : 'btn-outline-success'; ?>">
                    <i class="fas fa-utensils mr-1"></i>Makanan
                </a>
                <a href="<?= base_url('owner/produk?kategori=Minuman'); ?>" class="btn btn-sm <?= ($kategori_aktif == 'Minuman') ? 'btn-info' : 'btn-outline-info'; ?>">
                ...
                <tbody>
                    <?php foreach ($produk as $key => $value) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?= base_url('owner/produk/ubah/' . $value['id_produk']); ?>" class="btn btn-warning btn-icon-split btn-sm">
                                    <span class="icon text-white-50">
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        $.ajax({
                            type: 'post',
                            url: "<?= base_url("owner/produk/hapus"); ?>",
                            data: 'id=' + idnya,
                            success: function() {
                                swal("Produk berhasil terhapus!", {
                                    ...
                                    if (oke) {
                                        location = "<?= base_url("owner/produk"); ?>"
                                    }
                                });
                            }
                        })
